...
SWIFT_CLASS("_TtC8Test_App11AppDelegate") SWIFT_AVAILABILITY(ios,introduced=13.0)
...
SWIFT_CLASS("_TtC8Test_App13SceneDelegate") SWIFT_AVAILABILITY(ios,introduced=13.0)
...
- (void)switchValueChanged:(UISwitch * _Nonnull)sender;
- (void)amountTextFieldDidChange:(UITextField * _Nonnull)textField;
- (void)mobileTextFieldDidChange:(UITextField * _Nonnull)textField;
- (void)emailTextFieldDidChange:(UITextField * _Nonnull)textField;
- (void)generateRandomOrderID;
- (void)orderIDTextFieldDidChange:(UITextField * _Nonnull)textField;
- (void)startPayment;
- (void)manageSOF;
